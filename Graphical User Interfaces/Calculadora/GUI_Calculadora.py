...
# Boton reset calculadora --> CORREGIR LA FUNCION DE RESET, YA QUE SOLO ESTOY RESETEANDO LA PANTALLA Y ASIGNANDO UN VALOR AL NUMERO QUE APARECE EN LA PANTALLA, PERO NO ESTOY ELIMINANDO LO QUE SE QUEDA ALMACENADO EN LAS VARIABLES, POR LO TANTO ME ARROJA UN ERROR CUANDO DESPUES DEL RESET QUIERO HACER MAS OPERACIONES, YA QUE SIGUE TENIENDO LOS VALORES DE LAS VARIABLES QUE YA HABIA ALMACENADO, AUNQUE VISUALMENTE EN LA PANTALLA DE LA CALCULADORA YA NO HAY VALOR ALGUNO
